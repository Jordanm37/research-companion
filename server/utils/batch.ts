 ...
 *
 * Generic batch processing with rate limiting and automatic retries.
 * Use for any task that processes multiple items through an LLM or external API.
 */
 ...
 * Use when you need real-time progress updates to the client.
 *
 * @param items - Array of items to process
 * @param processor - Async function to process each item
